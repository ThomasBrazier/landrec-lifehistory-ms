...
%DIF DEL Submission_JEB/main_anonymous.tex   Tue Nov  5 11:12:03 2024
%DIF ADD main_anonymous.tex                  Wed Nov  6 11:46:41 2024
...
\usepackage{biorxiv}
%DIF 24c24
%DIF < \usepackage[backend=biber,eprint=false,isbn=false,url=false,style=authoryear,date=year]{biblatex}
%DIF -------
\usepackage[backend=biber,eprint=false,isbn=false,url=false,style=authoryear,date=year,uniquename=false]{biblatex} %DIF > 
%DIF -------
...
\begin{abstract}
Meiotic recombination is a central mechanism underlying sexual reproduction among eukaryotes. In many species, the recombination rate is strongly constrained by chromosome size, as the number of crossovers per chromosome generally ranges between one and no more than a few (around three to five). Yet, recombination rates are variable and can evolve between species, in particular when they differ in their reproductive system. According to theory, indirect selection towards higher recombination rates is expected to be stronger in \DIFdelbegin \DIFdel{populations with a non-random mating system}\DIFdelend \DIFaddbegin \DIFadd{inbred populations}\DIFaddend , such as selfing species compared to randomly mating species. To test for the impact of the mating system on the evolution of recombination rates, we leveraged a dataset with genetic maps, genome sizes, chromosome numbers and life history traits in 200 seed plant species. After controlling for the chromosome size effect, the phylogeny and map quality, we found a joint positive effect of the mating system and longevity on recombination rates, with higher recombination rates in mixed-mating and selfing species. We also found that mixed-mating and selfing species had a significantly higher number of crossovers in larger chromosomes than outcrossing species, suggesting selection for relaxed crossover interference in these former species. Our results point to the mating system as an important factor potentially shaping the evolution of recombination despite \DIFdelbegin \DIFdel{the strong constraints imposed }\DIFdelend \DIFaddbegin \DIFadd{mechanical constraints acting }\DIFaddend on the number of crossovers per chromosome.
\end{abstract}
...
In this article, we present an analysis of a dataset consisting of about 200 plant species for which genome size, number of chromosomes and genetic map length are available. Species were categorized based on their mating system and other life-history traits. The results show that species classified as mixed mating or selfing tend to have higher chromosome map lengths than outcrossing species, thus confirming the positive effect of selfing on recombination found in previous studies. Furthermore, mixed-mating and selfing species with larger chromosomes tend to have higher numbers of crossovers per chromosome than species with smaller chromosomes, while this trend is not observed in outcrossing species. \DIFdelbegin \DIFdel{Among the other traits tested, only }\DIFdelend \DIFaddbegin \DIFadd{As predictions have also been made concerning possible effects of longevity, domestication or ploidy on the evolution of recombination rates (\mbox{%DIFAUXCMD
\cite{ross-ibarraGenomeSizeRecombination2007a,burtMammalianChiasmaFrequencies1987,bombliesChallengeEvolvingStable2016}}\hskip0pt%DIFAUXCMD
), we investigated the impact of these other life history traits combined with the mating system. Only }\DIFaddend longevity showed a significant association with recombination, with medium-lived species presenting lower recombination rates than short-lived or long-lived species.
...
The original dataset with total genetic map length (cM), number of chromosomes and genome physical size (Mb) was retrieved from Stapley et al. (\citeyear{stapleyVariationRecombinationFrequency2017}). We added \DIFaddbegin \DIFadd{the }\DIFaddend genetic map length and genome \DIFdelbegin \DIFdel{sizes for }\DIFdelend \DIFaddbegin \DIFadd{size of }\DIFaddend 24 new species to the 184 species already in Stapley et al. (\citeyear{stapleyVariationRecombinationFrequency2017}). This final dataset contained a list of 208 species. We returned to original publications to retrieve the exact ploidy level, the number of markers on the final map and the number of progeny. In order to properly control for the chromosome size effect already assessed in this data (\cite{stapleyVariationRecombinationFrequency2017}), we also defined new genomic variables, such as the average chromosome genetic map length (cM/chromosome) and the residuals of the linear regression of recombination rates (cM/Mb) as a function of average chromosome size (Mb).


\subsection*{Life History Traits}


 Based on a literature search, we gathered Life History Traits data for every species (Table \ref{table:tableS1}). We first retrieved mating system information, using the coarse classification outcrossing / mixed / selfing, when directly given in the literature. To complete the characterization of the mating system, we collected other reproductive traits: sexual system (andromonoecy, dioecy, gynodioecy, hermaphroditism, monoecy), self incompatibility (SI) status (\DIFdelbegin \DIFdel{self-incompatible }\DIFdelend \DIFaddbegin \DIFadd{self-compatible }\DIFaddend and self-incompatible) and outcrossing rate, which we used to \DIFdelbegin \DIFdel{characterized }\DIFdelend \DIFaddbegin \DIFadd{characterize }\DIFaddend the mating system: dioecious and SI species were classified as outcrossing; based on outcrossing rate (t) we classified species as outcrossing for t $>$ 0.80, mixed for 0.2 $<$ t $<$ 0.8 and selfing for t $<$ 0.2. We added the life form (herb, liana, shrub, tree, vine) and the life span (annual, biannual, perennial), which are associated with the mating system. In addition\DIFaddbegin \DIFadd{, }\DIFaddend it has been proposed that \DIFaddbegin \DIFadd{a }\DIFaddend long life-span \DIFdelbegin \DIFdel{should select more recombination }\DIFdelend \DIFaddbegin \DIFadd{may favour higher recombination rates }\DIFaddend (\cite{burtMammalianChiasmaFrequencies1987}), although the underlying mechanism is unclear. As some categories were represented by only a few species and some traits were correlated, we defined three categories reflecting longevity: annual species, perennial non-woody species (herbs and vines), and woody perennials (trees, shrubs and lianas). We also included the cultivation status (cultivated, wild), as domestication has been \DIFdelbegin \DIFdel{also }\DIFdelend proposed to select higher recombination \DIFdelbegin \DIFdel{rate }\DIFdelend \DIFaddbegin \DIFadd{rates }\DIFaddend because of recent and prolonged episodes of directional selection (\cite{ross-ibarraGenomeSizeRecombination2007a,burtMammalianChiasmaFrequencies1987}). Finally, we categorized species as diploid (ploidy level = 2) or polyploid (ploidy level $>$ 2). \DIFdelbegin \DIFdel{We added more phylogenetic levels(class, family) }\DIFdelend \DIFaddbegin \DIFadd{Besides the genus and species, we added the class and family phylogenetic levels, }\DIFaddend and we grouped species in large phylogenetic families (Superasterids, Lilioids + Alismatids Superrosids, Commelinids, Magnoliids, Basal eudicots, Conifers)\DIFaddbegin \DIFadd{, as in Stapley et al. }\citeyear{stapleyVariationRecombinationFrequency2017}\DIFaddend . The full dataset is available as Table \ref{table:tableS1}.

 
\subsection*{Phylogenetic signal}


We used the 'phytools' R package to manipulate phylogenetic tree data and to statistically test for a phylogenetic signal (\cite{revellPhytoolsUpdatedEcosystem2024}). The phylogenetic time-calibrated supertree used for the comparative phylogenetic dataset was retrieved from Smith and Brown (\cite{smithConstructingBroadlyInclusive2018}). Tip labels were curated to remove subspecies and cultivar annotations and one tip per species was retained. Species \DIFdelbegin \DIFdel{missing in the tree were assigned randomly to a sister }\DIFdelend \DIFaddbegin \DIFadd{in our dataset but missing from the Smith and Brown reference tree were randomly branched to a }\DIFaddend species of the same genus. \DIFdelbegin \DIFdel{The }\DIFdelend \DIFaddbegin \DIFadd{As downstream comparative methods assume the tree is ultrametric (i.e. all branchs end at the same time), the }\DIFaddend tree was forced to be ultrametric. We computed two phylogenetic signal metrics, Blomberg's K and Pagel's lambda. \DIFaddbegin \DIFadd{Blomberg's K and Pagel's lambda measure how similar trait values are among closely related species, compared to a Brownian motion model where changes accumulate at a constant rate over time. }\DIFaddend We also fitted three evolution models (Brownian Motion, Ornstein-Ulhenbeck and Early Burst) to the distribution of recombination rates, chromosome genetic map length and the residuals of the regression presented above.
...
\subsection*{\DIFdelbegin \DIFdel{Weak }\DIFdelend \DIFaddbegin \DIFadd{Moderate }\DIFaddend phylogenetic signal}


After controlling for the chromosome size effect, we also investigated how recombination rates evolved amongst the plant phylogeny. In order to test the significance and strength of the phylogenetic signal, we estimated two phylogenetic signal metrics (Blomberg’s K and Pagel’s lambda) and fitted three competing phylogenetic models (Brownian Motion, Ornstein-Uhlenbeck and Early-burst) to the continuous distribution of chromosome average genetic length and the residuals of the regression of recombination rates as a function of average chromosome size (Table \ref{table:table1}). Blomberg's K \DIFdelbegin \DIFdel{were not }\DIFdelend \DIFaddbegin \DIFadd{was }\DIFaddend significantly different from zero \DIFdelbegin \DIFdel{while }\DIFdelend \DIFaddbegin \DIFadd{for the residuals but not the genetic map length. In both cases }\DIFaddend Pagel's Lambda was around 0.5, both indicating a \DIFdelbegin \DIFdel{weak }\DIFdelend \DIFaddbegin \DIFadd{moderate }\DIFaddend phylogenetic signal. Based on the maximum Log-Likelihood criterion, the Ornstein-Uhlenbeck phylogenetic model was always preferred\DIFaddbegin \DIFadd{. Contrary to the random walk in the Brownian motion model, traits are assumed to evolve towards an optimal value within the Ornstein-Uhlenbeck model}\DIFaddend , suggesting that the recombination rate evolved under a constrained range.
...
\caption{Phylogenetic signal for the two proxies of recombination rates. Blomberg’s K and Pagel’s Lambda (and their respective p-value) and the Log-Likelihood \DIFaddbeginFL \DIFaddFL{and AICc }\DIFaddendFL of the three phylogenetic models (Brownian Motion, Ornstein-Uhlenbeck and Early-burst, respectively). The best model according to the Log-Likelihood \DIFaddbeginFL \DIFaddFL{and AICc }\DIFaddendFL criterion is in bold. \DIFaddbeginFL \DIFaddFL{Significance codes: 0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1.}\DIFaddendFL }
\DIFdelbeginFL %DIFDELCMD < \begin{tabular}{llllllll}
%DIFDELCMD < %%%
\DIFdelendFL \DIFaddbeginFL \begin{adjustbox}{width=1\textwidth}
\small
\begin{tabular}{lllllllllll}
\DIFaddendFL Trait & K & K p-value & $\lambda$ & $\lambda$ p-value & Log-lik BM & Log-lik OU & Log-lik EB \DIFaddbeginFL & \DIFaddFL{AICc BM }& \DIFaddFL{AICc OU }& \DIFaddFL{AICc EB }\DIFaddendFL \\ \hline
Genetic map length & 0.09 & 0.117  & 0.46  & 0.01 \DIFaddbeginFL \DIFaddFL{** }\DIFaddendFL & -1155.09 & \textbf{-1091.53} & -1155.09 \DIFaddbeginFL & \DIFaddFL{2314.24 }&	\textbf{\DIFaddFL{2189.18}} &	\DIFaddFL{2316.31 }\DIFaddendFL \\
Residuals & 0.1  & 0.032 \DIFaddbeginFL \DIFaddFL{*  }\DIFaddendFL & 0.47 & 0.01 \DIFaddbeginFL \DIFaddFL{** }\DIFaddendFL & -173.16 & \textbf{-110.77} & -173.16 \DIFaddbeginFL & \DIFaddFL{350.37 }&	\textbf{\DIFaddFL{227.67}} &	\DIFaddFL{352.44 
}\DIFaddendFL \end{tabular}
\DIFaddbeginFL \end{adjustbox}
\DIFaddendFL \label{table:table1}
\end{table}
...
The \DIFdelbegin \DIFdel{effect }\DIFdelend \DIFaddbegin \DIFadd{effects }\DIFaddend of the mating system and longevity \DIFdelbegin \DIFdel{is }\DIFdelend \DIFaddbegin \DIFadd{are }\DIFaddend moderate, most likely because \DIFdelbegin \DIFdel{it is }\DIFdelend \DIFaddbegin \DIFadd{they are }\DIFaddend biologically much weaker than the dominant chromosome size effect. We were able to detect \DIFdelbegin \DIFdel{it }\DIFdelend \DIFaddbegin \DIFadd{them }\DIFaddend by leveraging a large curated dataset from Stapley et al. (\citeyear{stapleyVariationRecombinationFrequency2017}) plus 24 new species with a sampling across seed plants (angiosperms and gymnosperms). We also found that the results were robust to differences in map quality (approximated by marker density and number of progeny).


However, our dataset remains limited to detect complex effects. The interaction between chromosome size and the mating system is only a trend. We did not detect \DIFdelbegin \DIFdel{significant effects }\DIFdelend \DIFaddbegin \DIFadd{any significant effect }\DIFaddend for other life-history traits, despite strong expectations for some of them (e.g. cultivation status). There is multiple evidence of an effect of domestication on recombination rates in plants\DIFdelbegin \DIFdel{(\mbox{%DIFAUXCMD
\cite{ross-ibarraGenomeSizeRecombination2007a,dreissigVariationRecombinationRate2019,fuentesDomesticationShapesRecombination2021,schreiberRecombinationLandscapeDivergence2022}}\hskip0pt%DIFAUXCMD
}\DIFdelend \DIFaddbegin \DIFadd{, despite mixed evidence in animals (\mbox{%DIFAUXCMD
\cite{ross-ibarraGenomeSizeRecombination2007a,dreissigVariationRecombinationRate2019,fuentesDomesticationShapesRecombination2021,schreiberRecombinationLandscapeDivergence2022,munoz-fuentesStrongArtificialSelection2015}}\hskip0pt%DIFAUXCMD
}\DIFaddend ). However, we were not able to distinguish cultivated and domesticated species in our dataset and many species can be either strongly domesticated or \DIFaddbegin \DIFadd{crop }\DIFaddend wild relative populations. For such traits, a pairwise sampling of closely related species/populations with contrasted life history traits (wild vs. domesticated) should be more powerful than our large unstructured sampling. In particular, comparing species with the same number of chromosomes and similar genome size would avoid the strong confounding effect of chromosome size. It is likely that such an approach would also strengthen the detection of the effect of the mating system.
...
All scripts and data necessary to reproduce this study are available at the OSF repository \textbf{https://osf.io/\DIFdelbegin \DIFdel{XXX}\DIFdelend \DIFaddbegin \DIFadd{46cmu/}\DIFaddend }.
...
\begin{figure}[h!]
  ...
  \centering
  \caption{The recombination rates depend on the mating system and longevity. The combined effect of the mating system and longevity on the residuals of the regression recombination rate (cM/Mb) \DIFdelbeginFL \DIFdelFL{~ }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{as a function of }\DIFaddendFL chromosome size(Mb).
  }
  \label{figure:FigS5}
\end{figure}
...
\begin{table}[h!]
\centering{}
\caption{Forward model selection steps for the chromosome genetic map length and the residuals of the regression recombination rate \DIFdelbeginFL \DIFdelFL{~ }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{as a function of }\DIFaddendFL chromosome size. The Anova p-value and AIC/BIC values are provided for each 'lm' and 'pgls' model.}
\begin{tabular}{cccccccc}
\end{tabular}
\label{table:tableS2}
\end{table}
...
\begin{table}[h!]
\centering{}
\caption{Model fit and parameters estimates for the 'pgls' model testing the effect of the mating system, chromosome size, the interaction of the mating system and chromosome size, and the number of chromosomes. Chromosome genetic map length \DIFdelbeginFL \DIFdelFL{~ }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{$=$ }\DIFaddendFL mating system*chromosome size + chromosome number.}
\begin{tabular}{cccccccc}
\end{tabular}
\label{table:tableS3}
\end{table}
...
\begin{table}[h!]
\centering{}
\caption{Model fit and parameters estimates for the 'pgls' model testing the effect of marker density and number of progeny. Chromosome genetic map length \DIFdelbeginFL \DIFdelFL{~ }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{$=$ }\DIFaddendFL mating system + longevity + marker density + number of progeny.}
\begin{tabular}{cccccccc}
\end{tabular}
\label{table:tableS4}
\end{table}
